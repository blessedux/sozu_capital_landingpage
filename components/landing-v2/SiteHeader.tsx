...
export function SiteHeader({ copy, basePath }: SiteHeaderProps) {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-[200] border-b border-white/[0.05] bg-[rgba(10,10,10,0.8)] backdrop-blur-[6px]">
      ...
      <div
        className={cn(
          "overflow-hidden border-t border-white/[0.05] transition-[max-height] duration-300 ease-out lg:hidden",
